...
public class SampleBill {
 ...
 public static void main(String[] args) {
  ...
  String pdfFilename = "dynamic.pdf";
  SampleBill generateInvoice = new SampleBill();
 ...
 private void createPDF (String pdfFilename){
  ...
  try {
   String path = "C:/Users/Karthik/Desktop/WaterBill-Nov/" + pdfFilename;
 ...
 private void generateLayout(Document doc, PdfContentByte cb)  {
  ...
  try {
   ...
   //add the images
   Image companyLogo = Image.getInstance( IconCollections.class.getResource( "icons/appLogo_128.jpg" ) );
